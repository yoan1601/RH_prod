...
class ChgtContrat extends CI_Controller {
    ...
    public function toFichePoste() {
        ...
        $data["recrutement"]=$this->recrutement->getRecrutementById($idRecrutement);
        $data["devise"]="Ar";
        $data['superieurs'] = $this->chgtContrat->getSuperieurHierarchiques($niveau_poste, $data["employe"]->id_info_employe);
        $data['subalternes'] = $this->chgtContrat->getSubalternes($niveau_poste, $data["employe"]->->id_info_employe);
